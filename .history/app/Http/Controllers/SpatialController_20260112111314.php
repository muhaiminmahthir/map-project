...
class SpatialController extends Controller
{
     ...
     * Delete an area
     */
    public function deleteArea(string $viewKey, int $areaId)
    {
        $view = $this->postgis()
            ->table('map_views')
            ->where('view_key', $viewKey)
     ...
     * Delete a road
     */
    public function deleteRoad(string $viewKey, int $roadId)
    {
        $view = $this->postgis()
            ->table('map_views')
            ->where('view_key', $viewKey)
     ...
     * Delete a marker
     */
    public function deleteMarker(string $viewKey, int $markerId)
    {
        $view = $this->postgis()
            ->table('map_views')
            ->where('view_key', $viewKey)
