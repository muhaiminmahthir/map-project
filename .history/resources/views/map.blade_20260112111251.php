    ...
    <div id="sidebar">
      ...
      <div class="sidebar-section">
        ...
        <div class="view-actions">
          <button id="undoBtn" class="btn-undo" disabled title="Nothing to undo">↩ Undo</button>
      ...
      <div class="sidebar-section help-section">
        ...
        <div class="help-items">
          ...
          <div class="help-item">
            ...
            <span>Polyline = Road (click points)</span>
          </div>
          <div class="help-item">
            <span class="help-icon" style="background:#ff7800">✏️</span>
            <span>Freehand = Road (drag to draw)</span>
          </div>
          <div class="help-item">
