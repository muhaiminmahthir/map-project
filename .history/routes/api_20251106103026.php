...
Route::get('/admin-areas', [GeoController::class, 'adminAreas']);        // list children by level
Route::get('/admin-geometry/{relId}', [GeoController::class, 'geometry']); // bbox (+optional polygon)
