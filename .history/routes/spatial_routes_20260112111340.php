...
Route::prefix('spatial')->group(function () {
    ...
    // Delete area
    Route::delete('/views/{viewKey}/areas/{areaId}', [SpatialController::class, 'deleteArea'])
        ->name('spatial.areas.delete');
    ...
    // Delete road
    Route::delete('/views/{viewKey}/roads/{roadId}', [SpatialController::class, 'deleteRoad'])
        ->name('spatial.roads.delete');
    ...
    // Delete marker
    Route::delete('/views/{viewKey}/markers/{markerId}', [SpatialController::class, 'deleteMarker'])
        ->name('spatial.markers.delete');
